object LearningScala1 {
  ...
  val hello: String = "zheshisha!" //> hello  : String = Hola!
  println(hello) //> Hola!`
  ...
  // printf style:
  println(f"Pi is about $piSinglePrecision%.5f") //> Pi is about 3.142
  ...
  val doublePi:Float= 1.23456f
//  println(f"I have duoble Pi ti $doublePi%.3f")
  println(f"Pi is about $doublePi%.3f")
  println(s"what if ture = true ->$picard $bestCaptain")
}